...
```kotlin
implementation("com.debugbundle:debugbundle-spring-boot-starter:1.0.0")
```
...
```text
-javaagent:/opt/debugbundle/debugbundle-java-agent-1.0.0.jar=config=/etc/debugbundle/debugbundle.properties,capture-jul=true,capture-uncaught=true
```
...
```kotlin
dependencies {
  implementation(platform("com.debugbundle:debugbundle-java-parent:1.0.0"))
